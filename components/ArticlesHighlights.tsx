  ...
  return (
    <section
      ...
      <div
        ...
        } flex flex-col lg:flex-row items-center justify-between p-5 lg:p-8  w-[90vw] sm:w-[75vw] md:w-[70vw] lg:w-5/6 xl:w-3/4 2xl:w-1/2 lg:min-h-[400px] rounded-lg my-7 gap-2 lg:gap-9`}>
        {currentArticle ? (
