  ...
  return (
    <header
      className={`flex fixed top-0 ${
        isPageScrolled
          ? "bg-[#1c222abf] min-h-[70px] h-[9vh] items-center"
          : "bg-transparent h-[15vh]"
      } justify-between w-full z-50 object-contain py-4 px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-36 transition-all ease-in duration-300`}>
      <div
